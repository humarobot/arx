...
Vector6d Communicator::CalculateTorque(const Vector6d &qd, const Vector6d &vd, const Vector6d &tau) {
  ...
  tau_cmd(3) = pd(35, 1., arm_state_now_.joints[3].position, arm_state_now_.joints[3].velocity, qd(3), vd(3), tau(3));
  tau_cmd(4) = pd(15, 0.5, arm_state_now_.joints[4].position, arm_state_now_.joints[4].velocity, qd(4), vd(4), tau(4));
  tau_cmd(5) = pd(15, 0.5, arm_state_now_.joints[5].position, arm_state_now_.joints[5].velocity, qd(5), vd(5), tau(5));
  return tau_cmd;
}
