...
public:
    ...
    float lower_bound_sim[7] = { encos_down,encos_down,encos_down,encos_down,encos_down,encos_down,-3.14};
    float upper_bound_sim[7] = { encos_up,encos_up,encos_up,encos_up,encos_up,encos_up,3.14};
    ...
    // ros::Subscriber target_tf_sub = nh.subscribe<geometry_msgs::PoseStamped>("target_pose", 1000, &arx_arm::target_tf_Callback, this);

    geometry_msgs::PoseStamped curr_pos_stamped, target_pos_stamped;//注意是相机系
...
/////////////////////////////////////////////////////////////
    ...
    float tgt_pos[8]         = {(6.357f-0.1f),1.221,-0.734f,-0.744f,  (6.137f+0.1f),4.997f,7.041f,-0.423f};//平+衡车模式
